...
void UGFGameplayAbility::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
...
void UGFGameplayAbility::EndAbility(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo,
...
ACharacter* UGFGameplayAbility::GetCharacterFromActorInfo() const
{
